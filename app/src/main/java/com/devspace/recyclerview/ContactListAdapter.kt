...
import com.devspace.recyclerview.ContactListAdapter.ContactViewHolder
...
class ContactListAdapter : ListAdapter<Contact, ContactViewHolder>(ContactDiffUtils()) {
    ...
    // bind - atrelar o dado com a view
    ...
    private class ContactDiffUtils : DiffUtil.ItemCallback<Contact>() {
